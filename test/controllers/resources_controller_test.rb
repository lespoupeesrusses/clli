...
class ResourcesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resource" do
    assert_difference('Resource.count') do
      post resources_url, params: { resource: { abstract: @resource.abstract, title: @resource.title, url: @resource.url } }
    end
  ...
  test "should update resource" do
    patch resource_url(@resource), params: { resource: { abstract: @resource.abstract, title: @resource.title, url: @resource.url } }
